...
file_name = "./ans_simple_pendulum_eq_dissipative.csv"
...
def create_frame(num: int):
    ...
    b = 2
    plt.title(
        rf"$\frac{{d\theta}}{{dt}}=\omega, \frac{{d\omega}}{{dt}}=-a\sin(\theta)-b\omega, (a={a},b={b})$",
        fontsize=10,
        loc="center",
    )
...
images[0].save(
    "./vec_field_ans_simple_pendulum_dissipative_eq.gif",
    save_all=True,
