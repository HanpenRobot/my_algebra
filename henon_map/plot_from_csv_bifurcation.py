...
file_name = "./ans_henon_map_bifurcation.csv"
...
def draw(n: int):
    ...
    N_max = 90000
    plt.ylabel(rf"$x_n$, $(n > {N_max})$", fontsize=LABEL_FONT_SIZE)
    ...
    plt.plot(ans_A, ans_X, "o", ms=1, color=RT_LINE_COLOR)
...
res.save(f"henon_map_bifurcation.gif", writer="imagemagick")
