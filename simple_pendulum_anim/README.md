...
![./pendulum_animE.gif](./pendulum_animE.gif)
*Fig. 5 不動点$`\theta_{0}=0`$は不安定な不動点*
...
![./pendulum_anim_dissipativeA.gif](./pendulum_anim_dissipativeA.gif)
*Fig. 6 摩擦のある単振り子の方程式のアニメーション*

![./pendulum_anim_dissipativeB.gif](./pendulum_anim_dissipativeB.gif)
*Fig. 7 摩擦のある単振り子の方程式のアニメーション*

![./pendulum_anim_dissipativeC.gif](./pendulum_anim_dissipativeC.gif)
*Fig. 8 摩擦のある単振り子の方程式のアニメーション*

![./pendulum_anim_dissipativeD.gif](./pendulum_anim_dissipativeD.gif)
*Fig. 9 摩擦のある単振り子の方程式のアニメーション*
