...
+ 下記のLorentz方程式を$`\sigma = 10, R = 28, b = \frac{8}{3}`$、初期値$`x(0)=0.3, y(0)=0, z(0)=0`$の条件で4次のルンゲ・クッタ法で解き、その結果を3Dプロットした(Lorentz方程式のパラメータ$`\sigma, R, B`$と初期値$`x(0)=0.3, y(0)=0, z(0)=0`$は参考文献[1]の値を利用した)。
